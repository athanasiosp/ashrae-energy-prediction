...
joined %>% 
  ...
  geom_text(aes(label = building_id)) + 
...
```{r}
joined %>% 
  filter(building_id == 778)  %>% distinct(meter) #timestamp >= "2016-01-01", timestamp <= 2016-10-31)
  summarise(sum = sum(meter_reading))
