...
```{r}
summaries <- tibble("Min."= 0, "1st Qu."= 0, "Median" = 0, "Mean" = 0,  "3rd Qu."= 0," Max."= 0)

for (id in building_outliers) {
  print(id)
  joined %>% 
  ...
  pull(energy_sqm) %>%
   ...
   summary(joined[joined$building_id == 50, "energy_sqm"]) %>% class()
  
   apply(joined[joined$building_id == building , "energy_sqm"], margin, ...)
